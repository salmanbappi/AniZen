...
class AniyomiMPVView(context: Context, attributes: AttributeSet) : BaseMPVView(context, attributes) {
    ...
    private val observedProps = mapOf(
        "chapter" to MpvFormat.MPV_FORMAT_INT64,
        "chapter-list" to MpvFormat.MPV_FORMAT_NONE,
        ...
        "duration" to MpvFormat.MPV_FORMAT_INT64,
        "volume" to MpvFormat.MPV_FORMAT_INT64,
        "volume-max" to MpvFormat.MPV_FORMAT_INT64,
        "sid" to MpvFormat.MPV_FORMAT_STRING,
        "secondary-sid" to MpvFormat.MPV_FORMAT_STRING,
        "aid" to MpvFormat.MPV_FORMAT_STRING,
        "speed" to MpvFormat.MPV_FORMAT_DOUBLE,
        "video-zoom" to MpvFormat.MPV_FORMAT_DOUBLE,
        "video-pan-x" to MpvFormat.MPV_FORMAT_DOUBLE,
        "video-pan-y" to MpvFormat.MPV_FORMAT_DOUBLE,
        ...
        "core-idle" to MpvFormat.MPV_FORMAT_FLAG,
        "seeking" to MpvFormat.MPV_FORMAT_FLAG,
        "eof-reached" to MpvFormat.MPV_FORMAT_FLAG,
        "hwdec-current" to MpvFormat.MPV_FORMAT_STRING,
        "hwdec" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/current-anime/intro-length" to MpvFormat.MPV_FORMAT_INT64,
        "user-data/aniyomi/show_text" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/toggle_ui" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/show_panel" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/software_keyboard" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/set_button_title" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/reset_button_title" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/toggle_button" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/switch_episode" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/pause" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/seek_by" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/seek_to" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/seek_by_with_text" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/seek_to_with_text" to MpvFormat.MPV_FORMAT_STRING,
        "user-data/aniyomi/launch_int_picker" to MpvFormat.MPV_FORMAT_STRING,
    )
